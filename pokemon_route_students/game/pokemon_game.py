...
class PokemonGame:
    ...
    def total_attack(self, attacker_types, defender_types):
        ...
        for a in attacker_types:
            effectiveness_total = 1

            for d in defender_types:
                effectiveness = list(self.prolog.query(f"attack({a},{d},E)"))
                effectiveness_total *= effectiveness[0]['E']

            if effectiveness_total > bestValue:
                bestValue = effectiveness_total
